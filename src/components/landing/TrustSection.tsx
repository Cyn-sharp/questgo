      ...
      <div className="flex flex-col md:flex-row items-stretch gap-6 self-stretch w-full">
        {trustCards.map((card, index) => (
          <article
            key={card.title}
            className={`
              group shine-wrap flex flex-col items-start gap-4 p-6 flex-1
          ...
          >
            <div
              className="
                relative z-[1] w-12 h-12 flex items-center justify-center rounded-xl
                bg-[#fbf8f0] text-[#7a1f32]
                transition-all duration-300
                group-hover:bg-white/10 group-hover:text-[#c9a227]
            ...
            <h3
              className="
                relative z-[1] font-bold text-xl tracking-tight text-[#161414]
