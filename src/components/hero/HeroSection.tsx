    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center">
        <div className="flex flex-col items-start gap-6 max-w-xl">
          ...
          <h1 className="font-extrabold text-4xl sm:text-5xl md:text-6xl leading-[1.08] tracking-tight">
            <span className="text-[#7a1f32]">Turn Tasks Into </span>
            <span className="text-[#c9a227]">Opportunities</span>
          </h1>

          <p className="font-normal text-base md:text-lg leading-relaxed text-[#4a4340] max-w-md">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2">
            <a
              href="#find-quest"
              className="inline-flex items-center gap-2 bg-[#7a1f32] hover:bg-[#661a2a] text-white px-6 py-3 rounded-xl transition shadow-[0px_8px_18px_#7a1f3226] font-semibold text-[15px]"
            >
              Find a Quest
              <svg
                width="16"
            ...
            <a
              href="#post-quest"
              className="inline-flex items-center border-[1.5px] border-solid border-[#7a1f32] text-[#7a1f32] px-6 py-3 rounded-xl hover:bg-[#fff0f0] transition font-semibold text-[15px]"
            >
              Post a Quest
            </a>
          </div>
